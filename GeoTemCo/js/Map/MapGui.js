...
function MapGui(map, div, options, iid) {
	...
	if (options.mapSelection) {
		...
		this.mapTypeTitle.innerHTML = "Instrument Makers"//GeoTemConfig.getString('mapType');
...
//		this.mapContainer.style.width = w + "px";
	...
	this.setMapsDropdown = function() {
        ...
        this.mapTypeDropdown = new Dropdown(this.mapTypeSelector, dd_options, "Choose Instrument Maker");
	}
